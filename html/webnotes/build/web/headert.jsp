...
<body>
    ...
    %> 
    <script>
//            document.getElementById("/gallery.jsp").addClass("active");
...
<!-- banner -->
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						<nav class="link-effect-4" id="link-effect-4"> 
							<ul class="nav navbar-nav">
								<li id = "home"><a href="index.jsp" data-hover="Home">Home</a></li>
								<li id = "tutors"><a href="services.html" data-hover="TOP TUTORS">Top Tutors</a></li>
								<li id = "galleryw"><a href="gallery.html" data-hover="Gallery">Gallery</a></li>
        ...
        if(session.getAttribute("user") != null ){
            ...
            %> <script>
                ...
                document.getElementById("chng1").href = "logout.jsp";
