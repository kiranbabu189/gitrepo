...
public final class trendqs_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//                        String domain = request.getParameter("pg");
 ...
 out.println(rs.getString("question")); 
      ...
      out.write("                                        <form id=\"reply");
      out.print( q_id);
      out.write("\">\n");
      out.write("                                            <textarea id=\"qa");
      out.print( q_id );
      out.write("\" style=\"width:100%; display:none;\" oninput=\"txtchange(");
      out.print( id );
      out.write(")\" name=\"answer\"></textarea>\n");
      ...
      out.write("                                            <div>\n");
      out.write("                                                <button type=\"button\" style=\"display:none;\" id=\"ba");
      out.print( id );
      out.write("\" class=\"btn-success\" onclick=\"reply(");
      out.print( q_id );
      ...
      out.print( id );
      out.write(")\"></textarea>    \n");
      out.write("                                    <div><button type=\"submit\" style=\"display:none;\" id=\"ba");
      out.print( id );
      out.write("\" class=\"btn-success\">post</button></div>\n");
...
//                                           0000000000000000 g = Integer.parseInt(rs4.getString("c_user"));
 ...
 pageContext.include( red ); 
      ...
      out.write("                }\n");
      out.write("                function txtchange(x){\n");
      out.write("//                    $('#qa'+x).click(function(){\n");
      out.write("                        $('#ba'+x).show();\n");
      out.write("//                    })\n");
      out.write("                }\n");
      out.write("//                $(\"form#reply\").submit(function(e){\n");
      out.write("//                    e.preventDefault();\n");
      out.write("                function reply(x){\n");
      out.write("                    $.ajax({\n");
      out.write("                       url:'reply.jsp',\n");
      out.write("                       type:'post',\n");
      out.write("                       data:$('form#reply'+x).serialize(),\n");
      out.write("                       success: function(data){\n");
      out.write("                           if($.trim(data) == \"success\")\n");
      out.write("                              $(\"#qa\"+x).slideToggle(); \n");
      out.write("                              $('#ba'+x).hide();\n");
      out.write("                       },\n");
      out.write("                       error: function(){\n");
      out.write("                           alert(\"ssdf\");\n");
      out.write("                       }\n");
      out.write("                    });\n");
      out.write("                }\n");
      out.write("            </script>\n");
